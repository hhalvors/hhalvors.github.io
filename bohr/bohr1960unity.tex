...
\title{The Unity of Human Knowledge}
\author{Niels Bohr (with commentary by Hans Halvorson)}
\date{1960}
...
The question alluded to in the title for this address is as old as
civilization itself, but has acquired renewed attention in our days
with the increasing specialization of studies and social
activities. From various sides concern has been expressed with the
widespread confusion arising from the apparently divergent approaches
taken by humanists and scientists to human problems, and in this
connection there has even been talk about a cultural rift in modern
society. We must, however, not forget that we are living in times of
rapid developments in many fields of knowledge, reminiscent in such
respect of the age of European Renaissance.
...
that nature of which we are part ourselves.\sidenote{Bohr began
  speaking of ``the epistemological lesson of quantum physics''
  already in the 1920s. Discoveries in the natural sciences can
  sometimes provide deep lessons about who we are and what we can
  know. While epistemology and semantics are often considered to be
  apriori, scientific discovery can call for revision of what was
  considered to be apriori knowledge.}\footnote{Bohr's view here is
  ...
  ``subject'' and treat another part as ``object''.} Far from implying
...
question of the unity of knowledge new perspective.\footnote{The
  lesson from QM can help us get a more nuanced understanding of how
  knowledge from different domains can be related and
  integrated.}\footnote{Bohr speaks as if this is an old question ---
  ...
  positivists.} The pursuit of scientific inquiry with the aim of
...
of \hl{common language}. Mathematics is therefore not to be regarded
...
cumbersome.\footnote{Mathematics is just more language!}
...
tortoise.\footnote{Bohr always liked the idea that mathematics can
  ...
  avoiding paradox in atomic physics.}  How could the fleet-footed
...
the comprehension of all knowledge.\footnote{Bohr mixes up the forms
...
\hl{unambiguous} use of our most elementary concepts, and has changed
our attitude to the aim of physical science.\footnote{Elimination of
  ...
  \emph{eindeutig}, and Danish has \emph{entydig}.} Indeed, from our
present standpoint, physics is to be regarded not so much as the study
of something a priori given, but rather as the development of methods
for ordering and surveying human experience.\footnote{Some people
  ...
  with the natural world.} In this respect our task must be to account
...
\hl{unambiguously} communicated in the \hl{common human
  language}.\footnote{The task of physics is to provide objective
...
complications, the recognition of \hl{the extent to which the account
...
observers.\footnote{Bohr doesn't think that relativity theory provides
  ...
  \emph{laws} hold in all reference frames.}
...
instructive lesson as regards the consistency and scope of \hl{plain
...
describe and co-ordinate experience by means of the \hl{common
  language}.\footnote{According to Bohr, the mathematical formalism
...
New fundamental aspects of \hl{the observational
  problem}\footnote{Bohr is probably thinking here of the Danish word
  \emph{måleproblemet}, which is most literally translated as
  \emph{the measurement problem}. This phrase is used somewhat
  differently in the contemporary literature.} entailing a revision of
...
with by the observation.\footnote{Bohr suggests that `observation
  ...
  to add the qualification `relative to me'.}  It is true that when we
...
Faced with the question of \hl{how under such circumstances we can
...
investigation.\footnote{This passage suggests a complementarity
...
scales and regulated clocks necessary for the \hl{definition} of the
reference frame.\footnote{Sameness of position over time is definable
  ...
  unmoving.}\footnote{Bohr talks of physical objects, e.g.\ clocks and
  rods, as `defining' a reference frame. This notion deserves closer
  study.}  Conversely, the use of any arrangement suited to study
...
space-time coordination of their constituent particles.\footnote{Here
...
given.\footnote{There is a sort of explanation here for the
  probabilistic nature of quantum mechanics. But the explanation is a
  bit opaque.} Likewise we must be prepared that evidence, obtained by
...
a single picture. Indeed, evidence obtained under \hl{well-defined
...
\hl{common language}.\footnote{All that can be said about the atomic
...
\hl{under conditions specified in plain language}.\footnote{For
...
regularities of unsurpassed exactness, \hl{objective description can
  be achieved only by including in the account of the phenomena
  explicit reference to the experimental
  conditions},\footnote{Objective description calls for specifying the
...
possibilities of inquiry. We are here concerned with \hl{a general
...
philosophy.\footnote{Most likely a nod to Høffding, who was much
  concerned with the description of psychological experience.} It is
...
\hl{the subject-object separation} demands special attention. Every
\hl{unambiguous communication} about the state and activity of our
mind implies, of course, a separation between the content of our
consciousness and the background loosely referred to as
``ourselves'',\footnote{Objective description demands a clear
  demarcation of who is describing (subject) and what is being
  described (object).} but any attempt at exhaustive description of
the richness of conscious life demands in various situations a
different placing of the section between subject and
object.\footnote{The subject-object split can be moved around in order
...
quote a Danish poet and philosopher, Poul Martin M{\o}ller, who lived
...
this country.\footnote{The Danish philosophers Sibbern and M{\o}ller
  rejected Hegel's claim that he had overcome the subject-object
  distinction. M{\o}ller's most famous student, S{\o}ren Kierkegaard,
  continued his critique of Hegel.}  In his novel, called \emph{The
...
Especially I shall refer to a conversation between two cousins, one of
whom is very soberly efficient in practical affairs, of the type which
then, and even now, is known among students as a philistine, whereas
the other, called the licentiate, is addicted to remote philosophical
meditations detrimental to his social activities. When the philistine
reproaches the licentiate for not having made up his mind to use the
opportunities for finding a practical job, offered him by the kindness
of his friends, the poor licentiate apologizes most sincerely, but
explains the difficulties into which his reflections have brought him.

Thus he says:

My endless enquiries make it impossible for me to achieve
anything.\footnote{M{\o}ller portrays the licentiate as a one-sided
  person who knows how to reflect (\emph{at overveje}) but not how to
  act (\emph{at handle}). The are strong similarities here with the
  ``postponement argument'' in Kierkegaard's \emph{Concluding
    Unscientific Postscript}.}  Furthermore, I get to think about my
...
indeed again an ``I'' which stops at it.\footnote{M{\o}ller is poking
  ...
  reflection', brought about by a subjective act of will.} I become
...
I cannot in any way help you in sorting your many ``I''s. It is quite
outside my sphere of action, and I should either be or become as mad
as you if I let myself in for your superhuman reveries. My line is to
stick to palpable things and walk along the broad highway of common
sense; therefore my ``I''s never get tangled up.

Quite apart from the fine humour with which the story is told, it is
certainly not easy to give a more pertinent account of essential
aspects of the situation with which we all are faced. Fortunately, the
risk of falling into the deplorable situation of the licentiate is
small in normal life, where we become gradually accustomed to coping
with practical necessities and learn to communicate in \hl{common
  language} what we need and what is on our mind. In such adjustment
the balance between seriousness and humour, conspicuous in children’s
play and equally appreciated in mature life, plays no small part.
...
ages.\footnote{Bohr uses the English `contemplation' where he uses the
  Danish \emph{overvejelse}. He could just as well have used
  `consideration', but in any case, the state of mind is detached and
  tending in the direction of objectivity.

  The idea that \emph{overvejelse} is a complementary state of mind to
  willing (deciding, believing, and acting) goes back to at least
  Kierkegaard, although the word `complementarity' is unique to
  Bohr. In the \emph{Postscript}, Kierkegaard argues that making any
  decision requires subjectivity, and so is strictly incompatible with
  the state of indifferent contemplation.} Even if we cannot say
...
in themselves equally \hl{undefinable outside the context in which
  they are used}.\footnote{Sometimes a concept only makes sense within
  a certain context.}

\hl{The flexibility of the subject-object separation in the account of
  conscious life} corresponds to a richness of experience so
multifarious that it involves a variety of
approaches.\footnote{Introspection is a clear case where the line
  between subject and object can be moved around.} As regards our
...
common language entails reference to self-awareness.\footnote{Bohr is
  no behaviorist. An adequate description of another person requires
  reference to the same concepts we use to understand ourselves.} It
is evident, however, that all search for an \hl{ultimate
  subject}\footnote{Elsewhere Bohr uses ``final subject''.} is at
variance with the aim of objective description, which demands the
contraposition of subject and object.\footnote{Here Bohr is working
...
whole existence?\footnote{This claim sounds strange at first. But it's
...
in the great drama of existence \hl{we are ourselves both actors and
  spectators}.\footnote{The actor/spectator duality can be related
...
features of the common human situation.\footnote{If we are to speak of
...
In fact, as is not least conspicuous in European history, contact
between nations has often resulted in the fusion of cultures retaining
valuable elements of the original national traditions. The question of
how to ameliorate the so-called cultural rift in modern societies,
which has attracted so much attention at this meeting, is after all a
more restricted educational problem, the attitude to which would seem
to call not only for information but, as I think everyone will agree,
also for some humour. A most serious task is, however, to promote
mutual understanding between nations with very different cultural
backgrounds.

Indeed, the rapid progress of science and technology in our days,
which entails unique promises for the promotion of human welfare, and
at the same time imminent menaces to universal security, presents our
whole civilization with a veritable challenge. Certainly, every
increase in knowledge and potentialities has always implied a greater
responsibility, but at the present moment, when the fate of all
peoples is inseparably connected, a collaboration in mutual
confidence, based on appreciation of every aspect of the common human
position, is more necessary than ever before in the history of
mankind.
